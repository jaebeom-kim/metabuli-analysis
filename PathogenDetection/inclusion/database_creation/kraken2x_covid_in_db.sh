...
# Taxonomy files
# cp -r ./taxonomy /data3/jaebeom/benchmarks/covid_inclusion/db_with_human/kraken2x

# mkdir -p /data3/jaebeom/benchmarks/covid_inclusion/db_with_human/kraken2x/library
...
kraken2-build --add-to-library /data3/jaebeom/benchmarks/covid_inclusion/db_with_human/proteomes/viral.protein.filtered.5var+huamn.kraken2x.faa  \
    --db /data3/jaebeom/benchmarks/covid_inclusion/db_with_human/kraken2x --protein

kraken2-build --build --protein --db /data3/jaebeom/benchmarks/covid_inclusion/db_with_human/kraken2x \
    --threads 32

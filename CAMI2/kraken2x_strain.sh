...
do
 ~/kraken2/kraken2 --db ./ --paired \
	 --report /data3/jaebeom/benchmarks/cami-gtdb/results/strain/kraken2x/str_${idx}_report \
	 --threads 32 \
	 ...
	 > /data3/jaebeom/benchmarks/cami-gtdb/results/strain/kraken2x/str_${idx}_readclassification.tsv
done

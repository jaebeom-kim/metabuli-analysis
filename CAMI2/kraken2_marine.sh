...
for idx in ${arr[@]}
do
	~/kraken2/kraken2 --db ./ --paired --report /data3/jaebeom/benchmarks/cami-gtdb/results/marine/kraken2/mar_0512_${idx}_report.tsv \
	 --threads 32 \
	 ...
	 > /data3/jaebeom/benchmarks/cami-gtdb/results/marine/kraken2/mar_0512_${idx}_readclassification.tsv
done

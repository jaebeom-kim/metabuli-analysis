...
#     /mnt/scratch/jaebeom/gtdb_202_inclusion/databases/metabuli \
#     --taxonomy-path ~/metabuli-analysis/ProkaryoteBenchmark/database_creation/taxonomy

# find /mnt/scratch/jaebeom/gtdb_202_inclusion/databases/metabuli -name '*.fna' \
#     > /mnt/scratch/jaebeom/gtdb_202_inclusion/databases/metabuli/library-files.txt

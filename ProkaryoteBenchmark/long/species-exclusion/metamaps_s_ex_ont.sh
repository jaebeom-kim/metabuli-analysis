...
{ /usr/bin/time time -v  ~/bin/MetaMaps/metamaps classify \
    -t 32 \
    --mappings /fast/jaebeom/long-read/results/metamaps/exclusion/sequel_ccs_result \
    --DB /mnt/scratch/jaebeom/gtdb_202_exclusion/databases/metamaps 
} 2> /fast/jaebeom/long-read/results/metamaps/exclusion/classify_sequel_ccs.time

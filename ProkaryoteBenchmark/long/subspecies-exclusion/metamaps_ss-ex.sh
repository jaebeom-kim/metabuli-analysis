...
~/bin/MetaMaps/metamaps classify \
    -t 32 \
    --mappings /mnt/scratch/jaebeom/gtdb_202_ss_exclusion/results/metamaps/ss-exclusion_sequel_ccs_result \
    --DB /mnt/scratch/jaebeom/gtdb_202_ss_exclusion/db/metamaps
} 2> /mnt/scratch/jaebeom/gtdb_202_ss_exclusion/results/metamaps/ss-exclusion_classify_sequel_ccs.time
